...
#' @param MACs_observ MACs from observed data
#' @param num_perms number of permutations to run
#' @param max_lag_prop maximum lag to consider
#' @param FDR_cutoffs number of FDR cutoffs to calculate
#' @param perm_file_name name of file to write results tos
#'
#' @return permuted MACs and lags
#' @export
MAC_perm <- function(
    data,
    MACs_observ,
